...
from .ContextualStringEmbeddings import ContextualStringEmbeddings


class ConStringBiLSTM:
    def __init__(self, embeddingsLookup, params=None):
        ...
        if 'constring_embeddings' not in self.params['featureNames']:
            self.params['featureNames'].append('constring_embeddings')
    ...
    def buildModel(self):
        ...
        for featureName in self.params['featureNames']:
            ...
            if featureName.endswith('_embeddings'):
                ...
                # Tokens Embeddings (100,) or contextual_string_embeddings (4096,)
    ...
    def saveModel(self, modelName, epoch, dev_score, test_score):
        ...
        filename = "constring_" + modelName + "_latest.h5"
    ...
    def loadModel(modelPath):
        ...
        embLookup = ContextualStringEmbeddings(embeddings_path)

        # Create new model object
        bilstm = ConStringBiLSTM(embLookup, params)
    ...
    def loadCRFModel(modelPath):
        ...
        embLookup = ContextualStringEmbeddings(embeddings_path)
        embLookup.ConStringEmbedModel = params['embeddingsConfig']['ConStringEmbedModel']
